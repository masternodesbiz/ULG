...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Ultragate server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Ultragate server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ultragate features */
        {"ultragate", "listmasternodes", &listmasternodes, true },
        {"ultragate", "getmasternodecount", &getmasternodecount, true },
        {"ultragate", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"ultragate", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"ultragate", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"ultragate", "masternodecurrent", &masternodecurrent, true },
        {"ultragate", "startmasternode", &startmasternode, true },
        {"ultragate", "createmasternodekey", &createmasternodekey, true },
        {"ultragate", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"ultragate", "listmasternodeconf", &listmasternodeconf, true },
        {"ultragate", "getmasternodestatus", &getmasternodestatus, true },
        {"ultragate", "getmasternodewinners", &getmasternodewinners, true },
        {"ultragate", "getmasternodescores", &getmasternodescores, true },
        {"ultragate", "preparebudget", &preparebudget, true },
        {"ultragate", "submitbudget", &submitbudget, true },
        {"ultragate", "mnbudgetvote", &mnbudgetvote, true },
        {"ultragate", "getbudgetvotes", &getbudgetvotes, true },
        {"ultragate", "getnextsuperblock", &getnextsuperblock, true },
        {"ultragate", "getbudgetprojection", &getbudgetprojection, true },
        {"ultragate", "getbudgetinfo", &getbudgetinfo, true },
        {"ultragate", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"ultragate", "mnfinalbudget", &mnfinalbudget, true },
        ...
        {"zerocoin", "getzulgseed", &getzulgseed, false },
        {"zerocoin", "setzulgseed", &setzulgseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzulg", &searchdzulg, false },
        {"zerocoin", "dzulgstate", &dzulgstate, false },
...
{
    return "> ultragate-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32553/\n";
}
